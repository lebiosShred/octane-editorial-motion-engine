...
export class BeatDirectorEngine {
  public static beats: BeatSpec[] = [
    // Act I: The Enterprise Bottleneck (Beats 1-5 | f0 - f930)
    {
      id: 'beat_01_stall',
      beatIndex: 0,
      startFrame: 0,
      ...
      camera: { position: [0, 0.8, 7.2], lookAt: [0, 0, 0], fov: 36, roll: 0 },
    },
    {
      ...
      camera: { position: [0.8, 0.4, 5.8], lookAt: [0.2, 0, 0], fov: 34, roll: 0 },
    },
    {
      ...
      camera: { position: [-1.0, 0.4, 4.6], lookAt: [-0.4, 0, 0], fov: 30, roll: 0 },
    },
    {
      ...
      camera: { position: [-0.4, 0.2, 3.8], lookAt: [0.1, 0.05, 0], fov: 28, roll: 0.015 },
    },
    {
      ...
      camera: { position: [0.4, 0.4, 4.8], lookAt: [0.2, -0.1, 0], fov: 32, roll: -0.04 },
    },
    ...
    // Act II: The Governed Agent Catalog (Beats 6-9 | f930 - f1860)
    {
      ...
      camera: { position: [0, 3.0, 7.8], lookAt: [0, 0.4, 0], fov: 36, roll: 0 },
    },
    {
      ...
      camera: { position: [1.8, 2.0, 6.2], lookAt: [0, 0.2, 0], fov: 36, roll: 0 },
    },
    {
      ...
      camera: { position: [-1.6, 1.8, 5.8], lookAt: [-0.3, 0, 0], fov: 33, roll: 0 },
    },
    {
      ...
      camera: { position: [0, 1.4, 5.4], lookAt: [0, 0, 0], fov: 32, roll: 0 },
    },
    ...
    // Act III: Autonomous Execution & Human Guardrails (Beats 10-14 | f1860 - f2718)
    {
      ...
      camera: { position: [-1.4, 1.6, 6.4], lookAt: [0, 0, 0], fov: 34, roll: 0 },
    },
    {
      ...
      camera: { position: [1.2, 1.2, 5.2], lookAt: [0.5, 0, 0], fov: 32, roll: 0 },
    },
    {
      ...
      camera: { position: [-1.8, 0.8, 3.8], lookAt: [-1.4, 0.3, 0], fov: 27, roll: 0 },
    },
    {
      ...
      camera: { position: [0.6, -0.2, 4.0], lookAt: [1.2, -0.5, 0], fov: 27, roll: 0 },
    },
    {
      ...
      camera: { position: [1.8, 0.3, 3.4], lookAt: [2.0, 0.15, 0], fov: 25, roll: 0.02 },
    },
    ...
    // Act IV: Distributed Observability & Velocity Payoff (Beats 15-16 | f2718 - f3407)
    {
      ...
      camera: { position: [-0.8, 1.2, 5.4], lookAt: [-0.3, 0.15, 0], fov: 32, roll: 0 },
    },
    {
      ...
      camera: { position: [0, 1.8, 7.8], lookAt: [0, 0, 0], fov: 38, roll: 0 },
    },
  ];
